import { REGION_COORDS, REGION_NAMES } from "./region-data.js?v=0.9.4";
import { createCfsmApi, createPoller, hasStoredToken, readStoredToken } from "./cfsm-api.js?v=0.9.4";
import { TURNSTILE_REASON, TURNSTILE_STATE, createTurnstileChain, createTurnstileRuntime } from "./cfsm-turnstile.js?v=0.9.4";
import { DEFAULT_SUBSCRIBE_SCOPE, buildWsUrl, createRealtimeChannel, extractSamples, isReportGroupStale, isReportStale, mergeStatusUpdate, normalizeIds } from "./cfsm-realtime.js?v=0.9.4";
import { DEFAULT_SETTINGS, POLL_INTERVAL_MAX, POLL_INTERVAL_MIN, SECTION_LABELS, THEME_SETTINGS, localizedValue, mergeThemeSettings, normalizeSettingValue, readThemeSettings, settingLabel, settingsMeta } from "./theme-config.js?v=0.9.4";
import { mapHistoryRows, mapNode, mapServers, mapStatus } from "./cfsm-map.js?v=0.9.4";
...
function loadWorldLandVectors() {
  if (!worldLandVectorsPromise) {
    worldLandVectorsPromise = import("./world-data.js?v=0.9.4")
